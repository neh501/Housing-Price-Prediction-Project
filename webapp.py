...
with header:
    st.title('Area Wise House Price Predictor')
    
    

with model_feature_sel:
    st.header('Input Features')
    loc = st.selectbox('Select the Area in which you want your house to be located:', options=list(df5.columns[4:]))
    total_sqft = st.slider('Select the total sqft area of land:', min_value=min(df5.total_sqft),
